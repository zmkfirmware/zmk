...
Now that you have a repo created, see the instructions below for how ZMK CLI can automate some common tasks, or see [Customizing ZMK](customisation/index.md) for more hands-on customization information.
