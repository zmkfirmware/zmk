...
The list of low frequency I/O pins for the nRF52840 can be found [here](https://infocenter.nordicsemi.com/index.jsp?topic=%2Fps_nrf52840%2Fpin.html&cp=4_0_0_6_0).
...
Lastly, [enable the feature](#enabling-rgb-underglow). This can also be done in `Kconfig.defconfig`:

```kconfig
config ZMK_RGB_UNDERGLOW
  default y
  # If not using WS2812 LEDs, imply the appropriate *_STRIP.
  imply WS2812_STRIP
```
