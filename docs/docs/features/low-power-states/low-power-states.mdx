...
<Tabs groupId="advanced-methods" defaultValue="direct">
  ...
  <TabItem value="wakeup" label="Wakeup-only Keyswitch">
    The exact method of reusing a keyswitch to wake from the soft off state differs depending on whether said keyswitch is part of a direct GPIO kscan or part of a matrix kscan.
