...
That being said, there are specific [boards / shields](development/hardware-integration/index.md#boards--shields) that have been implemented and tested by the ZMK contributors, listed below.
