...
* **Kconfig:** Added a name to EC11's trigger mode choice, allowing it to be set in device Kconfig.defconfig ([40925d4](https://github.com/zmkfirmware/zmk/commit/40925d48e67b3eeaeb3e848a2287ed628de9f674))
