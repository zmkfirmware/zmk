...
#define ZMK_HID_REPORT_ID_NONE
#define ZMK_HID_KEYBOARD_REPORT_ID_DESC HID_REPORT_ID(ZMK_HID_REPORT_ID_KEYBOARD),
#define ZMK_HID_CONSUMER_REPORT_ID_DESC HID_REPORT_ID(ZMK_HID_REPORT_ID_CONSUMER),
#define ZMK_HID_MOUSE_REPORT_ID_DESC HID_REPORT_ID(ZMK_HID_REPORT_ID_MOUSE),

#if IS_ENABLED(CONFIG_ZMK_HID_INDICATORS)
#define ZMK_HID_KEYBOARD_LEDS_DESC                                                                 \
...
#if IS_ENABLED(CONFIG_ZMK_HID_REPORT_TYPE_NKRO)
#define ZMK_HID_KEYBOARD_KEYS_DESC                                                                 \
...
#define ZMK_HID_KEYBOARD_DESC(REPORT_ID)                                                           \
    HID_USAGE_PAGE(HID_USAGE_GEN_DESKTOP), HID_USAGE(HID_USAGE_GD_KEYBOARD),                       \
        ...
        ZMK_HID_KEYBOARD_LEDS_DESC HID_USAGE_PAGE(HID_USAGE_KEY),                                  \
        ZMK_HID_KEYBOARD_KEYS_DESC HID_END_COLLECTION

#if IS_ENABLED(CONFIG_ZMK_HID_CONSUMER_REPORT_USAGES_BASIC)
#define ZMK_HID_CONSUMER_USAGE_DESC                                                                \
    HID_LOGICAL_MIN8(0x00), HID_LOGICAL_MAX16(0xFF, 0x00), HID_USAGE_MIN8(0x00),                   \
        HID_USAGE_MAX8(0xFF), HID_REPORT_SIZE(0x08),
#elif IS_ENABLED(CONFIG_ZMK_HID_CONSUMER_REPORT_USAGES_FULL)
#define ZMK_HID_CONSUMER_USAGE_DESC                                                                \
...
#define ZMK_HID_CONSUMER_DESC(REPORT_ID)                                                           \
    HID_USAGE_PAGE(HID_USAGE_CONSUMER), HID_USAGE(HID_USAGE_CONSUMER_CONSUMER_CONTROL),            \
        HID_COLLECTION(HID_COLLECTION_APPLICATION), REPORT_ID HID_USAGE_PAGE(HID_USAGE_CONSUMER),  \
        ZMK_HID_CONSUMER_USAGE_DESC HID_REPORT_COUNT(CONFIG_ZMK_HID_CONSUMER_REPORT_SIZE),         \
        HID_INPUT(ZMK_HID_MAIN_VAL_DATA | ZMK_HID_MAIN_VAL_ARRAY | ZMK_HID_MAIN_VAL_ABS),          \
        HID_END_COLLECTION

#if IS_ENABLED(CONFIG_ZMK_POINTING_SMOOTH_SCROLLING)
#define ZMK_HID_MOUSE_WHEEL_RESOLUTION_FEATURE_DESC                                                \
    HID_USAGE(HID_USAGE_GD_RESOLUTION_MULTIPLIER), HID_LOGICAL_MIN8(0x00), HID_LOGICAL_MAX8(0x0F), \
        HID_PHYSICAL_MIN8(0x01), HID_PHYSICAL_MAX8(0x10), HID_REPORT_SIZE(0x04),                   \
        HID_REPORT_COUNT(0x01), HID_PUSH,                                                          \
        HID_FEATURE(ZMK_HID_MAIN_VAL_DATA | ZMK_HID_MAIN_VAL_VAR | ZMK_HID_MAIN_VAL_ABS),
#define ZMK_HID_MOUSE_HWHEEL_RESOLUTION_FEATURE_DESC                                               \
...
#define ZMK_HID_MOUSE_DESC(REPORT_ID)                                                              \
    HID_USAGE_PAGE(HID_USAGE_GD), HID_USAGE(HID_USAGE_GD_MOUSE),                                   \
        HID_COLLECTION(HID_COLLECTION_APPLICATION), REPORT_ID HID_USAGE(HID_USAGE_GD_POINTER),     \
        HID_COLLECTION(HID_COLLECTION_PHYSICAL), HID_USAGE_PAGE(HID_USAGE_BUTTON),                 \
        HID_USAGE_MIN8(0x1), HID_USAGE_MAX8(ZMK_HID_MOUSE_NUM_BUTTONS), HID_LOGICAL_MIN8(0x00),    \
        ...
        HID_USAGE(HID_USAGE_GD_Y), HID_LOGICAL_MIN16(0x00, 0x80), HID_LOGICAL_MAX16(0xFF, 0x7F),   \
        HID_REPORT_SIZE(0x10), HID_REPORT_COUNT(0x02),                                             \
        HID_INPUT(ZMK_HID_MAIN_VAL_DATA | ZMK_HID_MAIN_VAL_VAR | ZMK_HID_MAIN_VAL_REL),            \
        HID_COLLECTION(HID_COLLECTION_LOGICAL),                                                    \
        ZMK_HID_MOUSE_WHEEL_RESOLUTION_FEATURE_DESC HID_USAGE(HID_USAGE_GD_WHEEL),                 \
        HID_LOGICAL_MIN16(0x00, 0x80), HID_LOGICAL_MAX16(0xFF, 0x7F), HID_PHYSICAL_MIN8(0x00),     \
        HID_PHYSICAL_MAX8(0x00), HID_REPORT_SIZE(0x10), HID_REPORT_COUNT(0x01),                    \
        HID_INPUT(ZMK_HID_MAIN_VAL_DATA | ZMK_HID_MAIN_VAL_VAR | ZMK_HID_MAIN_VAL_REL),            \
        HID_END_COLLECTION, HID_COLLECTION(HID_COLLECTION_LOGICAL),                                \
        ZMK_HID_MOUSE_HWHEEL_RESOLUTION_FEATURE_DESC HID_USAGE_PAGE(HID_USAGE_CONSUMER),           \
