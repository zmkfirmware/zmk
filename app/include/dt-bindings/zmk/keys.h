...
/* System Dock */
#define SYSTEM_DOCK (ZMK_HID_USAGE(HID_USAGE_GD, HID_USAGE_GD_SYSTEM_DOCK))
#define SYS_DOCK (SYSTEM_DOCK)

/* System Undock */
#define SYSTEM_UNDOCK (ZMK_HID_USAGE(HID_USAGE_GD, HID_USAGE_GD_SYSTEM_UNDOCK))
#define SYS_UNDOCK (SYSTEM_UNDOCK)

/* System Setup */
#define SYSTEM_SETUP (ZMK_HID_USAGE(HID_USAGE_GD, HID_USAGE_GD_SYSTEM_SETUP))
#define SYS_SETUP (SYSTEM_SETUP)

/* System Break */
#define SYSTEM_BREAK (ZMK_HID_USAGE(HID_USAGE_GD, HID_USAGE_GD_SYSTEM_BREAK))
#define SYS_BREAK (SYSTEM_BREAK)

/* System Debugger Break */
#define SYSTEM_DEBUGGER_BREAK (ZMK_HID_USAGE(HID_USAGE_GD, HID_USAGE_GD_SYSTEM_DEBUGGER_BREAK))
#define SYS_DEBUGGER_BREAK (SYSTEM_DEBUGGER_BREAK)

/* Application Break */
#define APPLICATION_BREAK (ZMK_HID_USAGE(HID_USAGE_GD, HID_USAGE_GD_APPLICATION_BREAK))
#define APP_BREAK (APPLICATION_BREAK)

/* Application Debugger Break */
#define APPLICATION_DEBUGGER_BREAK                                                                 \
    (ZMK_HID_USAGE(HID_USAGE_GD, HID_USAGE_GD_APPLICATION_DEBUGGER_BREAK))
#define APP_DEBUGGER_BREAK (APPLICATION_DEBUGGER_BREAK)

/* System Speaker Mute */
#define SYSTEM_SPEAKER_MUTE (ZMK_HID_USAGE(HID_USAGE_GD, HID_USAGE_GD_SYSTEM_SPEAKER_MUTE))
#define SYS_SPEAKER_MUTE (SYSTEM_SPEAKER_MUTE)

/* System Hibernate */
#define SYSTEM_HIBERNATE (ZMK_HID_USAGE(HID_USAGE_GD, HID_USAGE_GD_SYSTEM_HIBERNATE))
#define SYS_HIBERNATE (SYSTEM_HIBERNATE)

/* System Display Invert */
#define SYSTEM_DISPLAY_INVERT (ZMK_HID_USAGE(HID_USAGE_GD, HID_USAGE_GD_SYSTEM_DISPLAY_INVERT))
#define SYS_DISPLAY_INVERT (SYSTEM_DISPLAY_INVERT)

/* System Display Internal */
#define SYSTEM_DISPLAY_INTERNAL (ZMK_HID_USAGE(HID_USAGE_GD, HID_USAGE_GD_SYSTEM_DISPLAY_INTERNAL))
#define SYS_DISPLAY_INTERNAL (SYSTEM_DISPLAY_INTERNAL)

/* System Display External */
#define SYSTEM_DISPLAY_EXTERNAL (ZMK_HID_USAGE(HID_USAGE_GD, HID_USAGE_GD_SYSTEM_DISPLAY_EXTERNAL))
#define SYS_DISPLAY_EXTERNAL (SYSTEM_DISPLAY_EXTERNAL)

/* System Display Both */
#define SYSTEM_DISPLAY_BOTH (ZMK_HID_USAGE(HID_USAGE_GD, HID_USAGE_GD_SYSTEM_DISPLAY_BOTH))
#define SYS_DISPLAY_BOTH (SYSTEM_DISPLAY_BOTH)

/* System Display Dual */
#define SYSTEM_DISPLAY_DUAL (ZMK_HID_USAGE(HID_USAGE_GD, HID_USAGE_GD_SYSTEM_DISPLAY_DUAL))
#define SYS_DISPLAY_DUAL (SYSTEM_DISPLAY_DUAL)

/* System Display Toggle Int/Ext Mode */
#define SYSTEM_DISPLAY_TOGGLE_INT_EXT_MODE                                                         \
    (ZMK_HID_USAGE(HID_USAGE_GD, HID_USAGE_GD_SYSTEM_DISPLAY_TOGGLE_INT_EXT_MODE))
#define SYS_DISPLAY_TOGGLE_INT_EXT_MODE (SYSTEM_DISPLAY_TOGGLE_INT_EXT_MODE)

/* System Display Swap Primary/Secondary */
#define SYSTEM_DISPLAY_SWAP_PRIMARY_SECONDARY                                                      \
    (ZMK_HID_USAGE(HID_USAGE_GD, HID_USAGE_GD_SYSTEM_DISPLAY_SWAP_PRIMARY_SECONDARY))
#define SYS_DISPLAY_SWAP_PRIMARY_SECONDARY (SYSTEM_DISPLAY_SWAP_PRIMARY_SECONDARY)
