...
/* Mouse Button 1 */
#define MOUSE_BUTTON1 (ZMK_HID_USAGE(HID_USAGE_BUTTON, HID_USAGE_BUTTON_BUTTON1))
#define LBTN (MOUSE_BUTTON1)
#define LMB (MOUSE_BUTTON1)
#define BTN1 (MOUSE_BUTTON1)

/* Mouse Button 2 */
#define MOUSE_BUTTON2 (ZMK_HID_USAGE(HID_USAGE_BUTTON, HID_USAGE_BUTTON_BUTTON2))
#define RBTN (MOUSE_BUTTON2)
#define RMB (MOUSE_BUTTON2)
#define BTN2 (MOUSE_BUTTON2)

/* Mouse Button 3 */
#define MOUSE_BUTTON3 (ZMK_HID_USAGE(HID_USAGE_BUTTON, HID_USAGE_BUTTON_BUTTON3))
#define MBTN (MOUSE_BUTTON3)
#define MMB (MOUSE_BUTTON3)
#define BTN3 (MOUSE_BUTTON3)

/* Mouse Button 4 */
#define MOUSE_BUTTON4 (ZMK_HID_USAGE(HID_USAGE_BUTTON, HID_USAGE_BUTTON_BUTTON4))
#define BBTN (MOUSE_BUTTON4)
#define BMB (MOUSE_BUTTON4)
#define BTN4 (MOUSE_BUTTON4)

/* Mouse Button 5 */
#define MOUSE_BUTTON5 (ZMK_HID_USAGE(HID_USAGE_BUTTON, HID_USAGE_BUTTON_BUTTON5))
#define FBTN (MOUSE_BUTTON5)
#define FMB (MOUSE_BUTTON5)
