...
// TODO: add a hard-poweroff behavior to avoid the interrupt handler
static int makerdiary_m60_init(void) {
    // back button
...
SYS_INIT(makerdiary_m60_init, APPLICATION, CONFIG_APPLICATION_INIT_PRIORITY);
